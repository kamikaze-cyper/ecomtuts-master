    ...
    def form_valid(self, form):
        ...
        if cart_id:
            ...
            if pm == "Khalti":
                ...
                return redirect(reverse("ecomapp:paytmrequest")+ "?o_id=" + str(order.id))
        else:
...
class paytmrequestview(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, "paytmrequest.html", context)

class paytmverifyview(View):
    def get(self, request, *args, **kwargs):
        import xml.etree.ElementTree as ET
        oid = request.GET.get("oid")
        amt = request.GET.get("amt")
        ...
        if status == "Success":
            ...
            return redirect("/paytm-request/?o_id="+order_id)
